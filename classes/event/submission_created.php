...
class submission_created extends \mod_assign\event\submission_created {
    ...
    public function get_description() {
        ...
        if ($this->other['groupid']) {
            ...
            return "The user with ID ({$a->userid}) created a OnlyOffice submission file named " /
        ...
        // Language string should not be used here.
        return "The user with ID ({$a->userid}) created a OnlyOffice submission file named ({$a->submissionfilename})" /
