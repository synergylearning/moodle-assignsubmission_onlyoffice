...
class provider implements
    ...
    public static function delete_submission_for_context(assign_plugin_request_data $requestdata) {
        ...
        $fs = get_file_storage();
        $fs->delete_area_files($requestdata->get_context()->id, onlyoffice::COMPONENT_NAME, onlyoffice::FILEAREA_SUBMISSIONS);

        // Delete records from assignsubmission_onlyoffice table.
        $DB->delete_records('assignsubmission_onlyoffice', ['assignment' => $requestdata->get_assign()->get_instance()->id]);
    }
    ...
    public static function delete_submission_for_userid(assign_plugin_request_data $deletedata) {
        ...
        $fs = get_file_storage();
        $fs->delete_area_files($deletedata->get_context()->id, onlyoffice::COMPONENT_NAME, onlyoffice::FILEAREA_SUBMISSIONS,
                               $submissionid);

        $DB->delete_records('assignsubmission_onlyoffice', [
    ...
    public static function delete_submissions(assign_plugin_request_data $deletedata) {
        ...
        $fs->delete_area_files_select($deletedata->get_context()->id, onlyoffice::COMPONENT_NAME,
                                      onlyoffice::FILEAREA_SUBMISSIONS, $sql, $params);

        $params['assignid'] = $deletedata->get_assignid();
        $DB->delete_records_select('assignsubmission_onlyoffice', "assignment = :assignid AND submission $sql", $params);
    }
}
